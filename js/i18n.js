...
const translations = {
    ko: {
        ...
        hospitalSearch: {
            ...
            regionTitle: '지역별 필터',
            reservationButton: '뇌질환 예약 진료 가능 병원 보기',
    ...
    en: {
        ...
        hospitalSearch: {
            ...
            reservationButton: 'View Brain Disease Reservation Hospitals',
    ...
    ja: {
        ...
        hospitalSearch: {
            ...
            reservationButton: '脳疾患予約診療可能病院を見る',
